    ...
    useEffect(() => {
        if (props.currentChosenLocation !== "") {
            ...
            axios({
                ...
                if (policeApiResult.status === 200 && policeApiResult.data.length > 0) {
                ...
                <form action="">
                    ...
                    }  */}
                    {
                        crimeArray.map((individualCrime) => {
                            ...
                            return <CrimeFile typeOfCrime={individualCrime.category} key={individualCrime.id} caseID={individualCrime.id} 
                            />
                        })
                    }
                    </fieldset>
